...
export const NEWS_CARDS: NewsCard[] = [
    ...
    },
    {
        ...
        body: "26/26 E2E tests. QryptSafe EIP-1167, zero admin keys, MIT license. Superseded by v4 (QryptAir EIP-712 upgrade).",
        link: { text: "View full record", href: "/sepolia-verified-v3" },
        decommissioned: true,
    },
    {
        id: "sepolia-v2-record",
        decor: <DecorV2Deployed />,
        accentColor: "#627EEA",
        tag: "v2 Superseded",
        title: "Sepolia Verified v2",
        body: "23/23 E2E tests. Pausable removed, nonce-based commit deduplication, SafeERC20 overflow protection. Superseded by v3.",
        link: { text: "View full record", href: "/sepolia-verified-v2" },
        decommissioned: true,
    },
    {
        id: "sepolia-v1-record",
        decor: <DecorV1Deployed />,
        accentColor: "#EF4444",
        tag: "v1 Historical",
        title: "Sepolia Verified v1",
        body: "12/12 tests. First deployment on Sepolia. Factory has admin keys. ShieldToken hardcoded 18 decimals. Superseded by v2.",
        link: { text: "View full record", href: "/sepolia-verified-v1" },
        decommissioned: true,
    },
];
    ...
    return (
        <div style={{ ...CARD_STYLE, position: "relative", padding: "16px 90px 16px 20px" }}>
            <div style={{ position: "absolute", top: 10, right: 12, zIndex: 2, width: 68, height: 68, filter: "drop-shadow(0 6px 24px rgba(98,126,234,0.6))" }}>
                <img src="/hacker-challenge-small.jpg" alt="" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "50%" }} />
            </div>
